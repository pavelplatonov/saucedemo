...
class CatalogPageLocators:
    ...
    ITEM_DESC_BACKPACK = (By.XPATH, "(//div[@class = 'inventory_item_desc'])[1]")
    ...
    ITEM_DESC_BOLT_T_SHIRT = (By.XPATH, "(//div[@class = 'inventory_item_desc'])[3]")
    PRICE_BOLT_T_SHIRT = (By.XPATH, "(//div[@class = 'inventory_item_price'])[3]")
    ...
    ITEM_DESC_BIKE_LIGHT = (By.XPATH, "(//div[@class = 'inventory_item_desc'])[2]")
    PRICE_BIKE_LIGHT = (By.XPATH, "(//div[@class = 'inventory_item_price'])[2]")
    ...
    ITEM_DESC_FLEECE_JACKET = (By.XPATH, "(//div[@class = 'inventory_item_desc'])[4]")
    PRICE_FLEECE_JACKET = (By.XPATH, "(//div[@class = 'inventory_item_price'])[4]")
    ...
    ITEM_DESC_T_SHIRT = (By.XPATH, "(//div[@class = 'inventory_item_desc'])[6]")
